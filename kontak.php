...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="kotak">
        <img width="100px" src="../image/DESA_SIDAMULYA.png" alt="" />
        <h2>Hubungi Kami</h2>
        <div class="flex">
          <div class="kotak1">
            <div class="svg email">
          ...
          <div class="kotak2">
            <form action="" method="post">
              <input class="input" type="text" placeholder="Your Name" name="nama" /><br />
              <input class="input" type="email" placeholder="Your Email" name="email"/><br />
              <textarea class="input massage" placeholder="Your Massage" cols="30" rows="20" name="isiPesan"></textarea><br />
